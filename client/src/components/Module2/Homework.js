...
function Homework() {
    return (
        ...
        <div className="hwmod2" id="homeassignmet2">
            ...
            <p>Positive Self-Talk – Choose a specific time everyday where you can read the list of positive affirmations given for 5 mins daily till the end of this week.
</p>
            </div>
