...
function Optimism() {
    return (
        ...
        <div className="opti-main" id="optimism">
            ...
            <p>It is important to note that positive reappraisal does not mean that we are living in denial or not accepting that something bad has happened to us but it helps us to accept the bad situation and helps us to focus on the best of that situation.
