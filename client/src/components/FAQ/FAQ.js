    ...
    return (
        ...
        <div className='faq-main'>
            ...
            <div className='faq-cont'>
                <h2 className="fcard-title" style={{ color: 'black' }}>Frequently Asked Questions (FAQ)</h2>
                ...
                <div class="mt-4">
                    <div class="accordion" id="accordion" role="tablist">
                        ...
                        <div class="fcard">
                            <div class="fcard-header" role="tab" id="heading-1">
                        ...
                        <div class="fcard">
                            <div class="fcard-header" role="tab" id="heading-2">
                        ...
                        <div class="fcard">
                            <div class="fcard-header" role="tab" id="heading-3">
                        ...
                        <div class="fcard">
                            <div class="fcard-header" role="tab" id="heading-4">
...
Any Suggestions related to present program can be directly sent to program moderator
                        ...
                        <div class="fcard">
                            <div class="fcard-header" role="tab" id="heading-5">
                        ...
                        <div class="fcard">
                            <div class="fcard-header" role="tab" id="heading-6">
